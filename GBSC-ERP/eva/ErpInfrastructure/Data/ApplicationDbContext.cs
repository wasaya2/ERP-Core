...
namespace ErpInfrastructure.Data
{
  public class ApplicationDbContext : IdentityDbContext<AppUser>
  {
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
      ...
      modelBuilder.Entity<MedicineRequest>().ToTable("Hims_MedicineRequest");
      modelBuilder.Entity<OtTerminology>().ToTable("Hims_OtTerminology");
      modelBuilder.Entity<OtProcedure>().ToTable("Hims_OtProcedure");
      modelBuilder.Entity<OtEquipment>().ToTable("Hims_OtEquipment");
      modelBuilder.Entity<LaproscopyFS>().ToTable("Hims_LaproscopyFS");
      modelBuilder.Entity<LaproscopySp>().ToTable("Hims_LaproscopySp");
      modelBuilder.Entity<Hystroscopy>().ToTable("Hims_Hystroscopy");
      ...
      modelBuilder.Entity<NonproductiveVisitReason>().ToTable("ETracker_NonproductiveVisitReason");
      modelBuilder.Entity<ShopCensusDetail>().ToTable("ETracker_SP_ShopCensusDetail");
      ...
      modelBuilder.Entity<GeneralSKU>().ToTable("Inv_Setup_GeneralSKU");
      ...
      modelBuilder.Entity<OtPatientCase>()
         .HasOne(a => a.OtProcedure)
         .WithMany()
         .HasForeignKey(x => x.OtProcedureId);
      ...
      modelBuilder.Entity<LaproscopyFS>()
        .HasOne(a => a.Patient)
        .WithMany()
        .HasForeignKey(x => x.PatientId);
      ...
      modelBuilder.Entity<LaproscopyFS>()
        .HasOne(a => a.Surgeon2)
        .WithMany()
        .HasForeignKey(x => x.Surgeon2Id);


      modelBuilder.Entity<LaproscopySp>()
          .HasOne(a => a.Patient)
          .WithMany()
          .HasForeignKey(x => x.PatientId);
      ...
      modelBuilder.Entity<Hystroscopy>()
          .HasOne(a => a.Patient)
          .WithMany()
          .HasForeignKey(x => x.PatientId);
      ...
      modelBuilder.Entity<UserStopSalary>()
  .HasKey(a => new { a.UserId, a.StopSalaryId });
      ...
      modelBuilder.Entity<AllowanceDeduction>()
          .HasOne(a => a.AllowanceArrear)
          .WithMany(b => b.AllowanceDeductions)
          .HasForeignKey(c => c.ArrearAllowanceId);
    ...
    public DbSet<LaproscopyFS> LaproscopyFses { get; set; }
    public DbSet<LaproscopySp> LaproscopySps { get; set; }
    public DbSet<Hystroscopy> Hystroscopies { get; set; }


    public DbSet<MedicineRequest> MedicineRequests { get; set; }
    public DbSet<OtTerminology> OtTerminologies { get; set; }
    public DbSet<OtProcedure> OtProcedures { get; set; }
    public DbSet<OtEquipment> OtEquipments { get; set; }
    //Visit
    ...
    public DbSet<GeneralSKU> GeneralSKUs { get; set; }
    ...
    public DbSet<NonproductiveVisitReason> NonproductiveVisitReasons { get; set; }
    public DbSet<ShopCensusDetail> ShopCensusDetails { get; set; }
